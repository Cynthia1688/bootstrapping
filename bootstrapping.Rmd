...
let's fit a regerssion of `price` on other variables and look at residuals
...
run a bootstap on this whole thing to get estimates for the effect of `stars` on `price`
